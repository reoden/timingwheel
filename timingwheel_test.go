...
func TestTickerMode_SingleTask(t *testing.T) {
	timer := NewTimer(time.Millisecond, 20, WithTickerMode())
	timer.Start()
	defer timer.Stop()
...
func TestTickerMode_Ordering(t *testing.T) {
	timer := NewTimer(time.Millisecond, 20, WithTickerMode())
	timer.Start()
	defer timer.Stop()
...
func TestTickerMode_Cancel(t *testing.T) {
	timer := NewTimer(time.Millisecond, 20, WithTickerMode())
	timer.Start()
	defer timer.Stop()
...
func TestTickerMode_OverflowWheel(t *testing.T) {
	timer := NewTimer(time.Millisecond, 20, WithTickerMode())
	timer.Start()
	defer timer.Stop()
...
func TestTickerMode_ManyTasks(t *testing.T) {
	timer := NewTimer(time.Millisecond, 20, WithTickerMode())
	timer.Start()
	defer timer.Stop()
...
func TestTickerMode_ImmediateExpiration(t *testing.T) {
	timer := NewTimer(time.Millisecond, 20, WithTickerMode())
	timer.Start()
	defer timer.Stop()
